...
/**
 * This is the model class for table "facturadebe".
 *
 * The followings are the available columns in table 'facturadebe':
 * @property integer $id
...
class Facturadebe extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('nroFactura',$this->nroFactura);
	 ...
	 * @return Facturadebe the static model class
	 */
